...
Public Class rptInvoiceListing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WSDC_Ortho.rptInvoiceListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInvoiceListing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvoiceListing = New rptInvoiceListing()
        rpt.Site = Me.Site
        Return rpt
    End Function
