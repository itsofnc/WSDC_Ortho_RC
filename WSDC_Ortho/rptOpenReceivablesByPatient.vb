...
Public Class rptOpenReceivablesByPatient
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptOpenReceivablesByPatient.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WSDC_Ortho.rptOpenReceivablesByPatient.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOpenReceivablesByPatient
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOpenReceivablesByPatient = New rptOpenReceivablesByPatient()
        rpt.Site = Me.Site
        Return rpt
    End Function
