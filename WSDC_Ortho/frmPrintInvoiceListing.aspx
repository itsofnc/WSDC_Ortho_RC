<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mstSite.master" CodeBehind="frmPrintInvoiceListing.aspx.vb" Inherits="WSDC_Ortho.frmPrintInvoiceListing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeaderContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <form id='frmPrintInvoiceListing' class="form-horizontal" role="form" runat="server">
        ...
        <div class="container">
            <h4 style="color: #2d6ca2;" class="col-sm-12">
                <asp:Label ID="lblTitle" runat="server" Text="Invoice Listing Report"></asp:Label></h4>
...
<asp:Content ID="Content3" ContentPlaceHolderID="pageJavaScripts" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            document.getElementById("#InvoiceListing").className += " active";
        });
