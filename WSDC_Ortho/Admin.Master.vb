Public Class Admin
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("user_type") = "1" Then
            'Admin Nav
            litNavigation.Text = "<ul class=""nav navbar-nav"">" &
                            ...
                            "        <li><a href=""frmListManager.aspx?id=Contracts_vw&mid=Contracts&add=ContractEntry.aspx"" onclick=""setListSession('contracts');"">Contract History</a></li>" &
                            ...
                            "    <ul class=""dropdown-menu"" role=""menu"">" &
                            "        <li><a href=""frmListManager.aspx?id=PaymentsPostedWithLinkToReverse_vw&vo=true"" onclick=""setListSession('');"">Payment History</a></li>" &
                            ...
                            "        <li><a href=""frmListManager.aspx?id=PaymentsPostedWithLinkToReverse_vw&add=PaymentPosting.aspx&vo=true"">Posted Payments</a></li>" &
                            "        <li><a href=""frmListManager.aspx?id=PatientPaymentsApplied_vw&vo=true"" onclick=""setListSession('');"">Patient Payments Applied</a></li>" &
                            "        <li><a href=""frmListManager.aspx?id=InsurancePaymentsApplied_vw&vo=true"" onclick=""setListSession('');"">Insurance Payments Applied</a></li>" &
                            "        <li><a href=""frmListManager.aspx?id=PaymentsReversed_vw&vo=true"">Reversed Payments</a></li>" &
                            "        <li><a href=""frmListManager.aspx?id=PaymentsUnposted_vw&vo=true"">Un-Posted Payments</a></li>" &
                            "        <li class=""divider""><a href=""#"">-------------</a></li>" &
                            "        <li id=""#DailyTotals""><a href=""frmPrintDailySummary.aspx"" onclick=""setListSession('');"">Summary of Daily Totals</a></li>" &
                            "        <li id=""#MonthlySummary""><a href=""frmPrintMonthlySummary.aspx"" onclick=""setListSession('');"">Monthly Group Summary</a></li>" &
                            "        <li id=""#ProductionStats""><a href=""frmPrintProductionStats.aspx"" onclick=""setListSession('');"">Production Statistics Report</a></li>" &
                            ...
                            "    <ul class=""dropdown-menu"" role=""menu"">" &
                            "       <li id=""#MasterLists""><a href=""frmListManager.aspx"" onclick=""setListSession('');"">Master Lists</a></li>" &
                            "    </ul>" &
                            "</li>" &
                        "</ul>"
        Else
            ...
            litNavigation.Text = "<ul class=""nav navbar-nav"">" &
                            ...
                            "    <a href=""#"" class=""dropdown-toggle"" data-toggle=""dropdown"" role=""button"" aria-expanded=""false"">Contracts<span class=""caret""></span></a>" &
                            "    <ul class=""dropdown-menu"" role=""menu"">" &
                            "        <li><a href=""frmListManager.aspx?id=Contracts_vw&vo=true"" onclick=""setListSession('contracts');"">Contract History</a></li>" &
                            "        <li class=""divider""></li>" &
                            ...
                            "        <li id=""#PaymentsRecord""><a href=""frmPrintPaymentsRecord.aspx"" onclick=""setListSession('');"">Payments Record</a></li>" &
                            "        <li id=""#PaymentSummary""><a href=""frmPaymentEntrySummary.aspx"" onclick=""setListSession('');"">Payment Summary</a></li>" &
                            "        <li><a href=""frmListManager.aspx?id=PaymentsPostedWithLinkToReverse_vw&vo=true"">Posted Payments</a></li>" &
                            "        <li><a href=""frmListManager.aspx?id=PatientPaymentsApplied_vw&vo=true"" onclick=""setListSession('');"">Patient Payments Applied</a></li>" &
                            "        <li><a href=""frmListManager.aspx?id=InsurancePaymentsApplied_vw&vo=true"" onclick=""setListSession('');"">Insurance Payments Applied</a></li>" &
                            "        <li><a href=""frmListManager.aspx?id=PaymentsReversed_vw&vo=true"">Reversed Payments</a></li>" &
                            "        <li><a href=""frmListManager.aspx?id=PaymentsUnposted_vw&vo=true"">Un-Posted Payments</a></li>" &
