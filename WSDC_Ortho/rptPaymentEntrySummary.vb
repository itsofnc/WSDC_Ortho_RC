...
Public Class rptPaymentEntrySummary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPaymentEntrySummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WSDC_Ortho.rptPaymentEntrySummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPaymentEntrySummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPaymentEntrySummary = New rptPaymentEntrySummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
