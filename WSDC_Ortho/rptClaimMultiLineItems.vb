...
Public Class rptClaimMultiLineItems
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptClaimMultiLineItems.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WSDC_Ortho.rptClaimMultiLineItems.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptClaimMultiLineItems
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptClaimMultiLineItems = New rptClaimMultiLineItems()
        rpt.Site = Me.Site
        Return rpt
    End Function
