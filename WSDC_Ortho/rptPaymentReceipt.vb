...
Public Class rptPaymentReceipt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WSDC_Ortho.rptPaymentReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPaymentReceipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPaymentReceipt = New rptPaymentReceipt()
        rpt.Site = Me.Site
        Return rpt
    End Function
