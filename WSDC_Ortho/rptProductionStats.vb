...
Public Class rptProductionStats
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WSDC_Ortho.rptProductionStats.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProductionStats
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductionStats = New rptProductionStats()
        rpt.Site = Me.Site
        Return rpt
    End Function
