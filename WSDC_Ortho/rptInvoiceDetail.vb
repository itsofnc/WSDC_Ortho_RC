...
Public Class rptInvoiceDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WSDC_Ortho.rptInvoiceDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInvoiceDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvoiceDetail = New rptInvoiceDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
