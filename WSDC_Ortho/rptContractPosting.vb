...
Public Class rptContractPosting
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WSDC_Ortho.rptContractPosting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptContractPosting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptContractPosting = New rptContractPosting()
        rpt.Site = Me.Site
        Return rpt
    End Function
