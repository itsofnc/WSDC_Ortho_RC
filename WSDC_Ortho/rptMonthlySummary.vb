...
Public Class rptMonthlySummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WSDC_Ortho.rptMonthlySummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMonthlySummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMonthlySummary = New rptMonthlySummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
