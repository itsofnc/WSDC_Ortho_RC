...
Public Class rptProviderSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WSDC_Ortho.rptProviderSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProviderSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProviderSummary = New rptProviderSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
