<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mstSite.Master" CodeBehind="frmPrintProviderSummary.aspx.vb" Inherits="WSDC_Ortho.frmPrintProviderSummary" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeaderContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<form id='frmPrintProviderSummary' class="form-horizontal" role="form" runat="server">
       <%--hidden default button so enter key doesn't submit the form--%>
        ...
        <div class="container">
            <h4 style="color: #2d6ca2;" class="col-sm-12">
                <asp:Label ID="lblTitle" runat="server" Text="Provider Summary"></asp:Label></h4>

            <div class="col-sm-12">
                <div class="form-group">
                    <a href="frmPrintProviderSummary.aspx">frmPrintProviderSummary.aspx</a>
                    <div class="col-sm-9">
                        <label for="dteBeginDate" class="col-xs-3">
                            Begin Date:
                            ...
                            <label for="dteEndDate" class="col-xs-3">
                                End Date:
                                <span style="padding-left: 0px;">
...
<asp:Content ID="Content3" ContentPlaceHolderID="pageJavaScripts" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            document.getElementById("#ProviderSummary").className += " active";
        });
