<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmSessionTimeout.aspx.vb" Inherits="WSDC_Ortho.frmSessionTimeout" %>
...
<body id="sessionTimeoutBody">
    <div class="container">
        ...
        <form id='frmSessionTimeout' class="form-horizontal" role="form" action="frmSessionTimeout.aspx" runat="server" defaultbutton="btnOK">
