<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mstSite.Master" CodeBehind="frmPrintMonthlySummary.aspx.vb" Inherits="WSDC_Ortho.frmPrintMonthlySummary" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeaderContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<form id='frmPrintMonthlySummary' class="form-horizontal" role="form" runat="server">
...
<asp:Content ID="Content3" ContentPlaceHolderID="pageJavaScripts" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            document.getElementById("#MonthlySummary").className += " active";
        });
        ...
        $('#dtpBeginDate')
          ...
          .on('changeDate', function (e) {
              ...
              $('#frmPrintMonthlySummary').formValidation('revalidateField', '<%=dteBeginDate.UniqueID%>');
          });
         ...
         $('#dtpEndDate')
          ...
          .on('changeDate', function (e) {
              // Revalidate the date field
              $('#frmPrintMonthlySummary').formValidation('revalidateField', '<%=dteEndDate.UniqueID%>');
        });

        $('#frmPrintMonthlySummary')
           .formValidation({
               framework: 'bootstrap',
               icon: {
