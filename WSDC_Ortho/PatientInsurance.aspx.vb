Public Class PatientInsurance
    ...
    Dim m_strTableName As String = "Patient_Insurance"
    Dim m_strPrimaryKey As String = " recid "
    Dim m_strFormCode As String = "PI"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsNothing(Request.QueryString("cid")) Then
            ...
            litPatientID.Text = "<h4 class=""col-md-12 text-center"">New Patient Insurance Entry</h4>"
        ...
        Else
            ...
            End If
            ' make sure patient insurance record exists, and gather data associated with it
            txtRecID.Text = System.Web.HttpContext.Current.Session(Trim(m_strPrimaryKey))
            Dim strSql As String = "select * from " & m_strTableName & "_vw where " & m_strPrimaryKey & " = '" & txtRecID.Text & "'"
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Response.Redirect("PatientInsurance.aspx?cid=" & intPatientRecid & "&mid=view")
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Response.Redirect("PatientInsurance.aspx?cid=" & cID & "&mid=edit")
    End Sub
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ' code to delete this patient if no history exists for it...
        Dim strSQL As String = "select * from contracts_insurance_vw where PatientNumber = '" & txtPatient_Id.Text & "' and (PrimaryInsurancePlan = '" & ddlPlan_Id.Text & "' or SecondaryInsurancePlan = '" & ddlPlan_Id.Text & "'"
        ...
        If tblPatientHistory.Rows.Count > 0 Then
            ...
            lblMessage.Text = "<script>alert('This patient insurance cannot be deleted.  A contract found associated with this patient/insurance plan.');</script>"
        Else
            ' delete patient and redirect to patient listing
            strSQL = "delete from Patients where recid = '" & txtRecID.Text & "'"
            g_IO_Execute_SQL(strSQL, False)
            Response.Redirect("frmListmanager.aspx?id=Patient_Insurance&add=PatientInsurance.aspx")
        End If
    End Sub

    Private Sub btnCancel_Click(sender As Object, e As EventArgs) Handles btnCancel.Click
        Response.Redirect("PatientInsurance.aspx?cid=" & txtRecID.Text & "&mid=view")
    End Sub
