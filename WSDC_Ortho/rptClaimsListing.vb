...
Public Class rptClaimsListing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WSDC_Ortho.rptClaimsListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_optionsSelected() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptClaimsListing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptClaimsListing = New rptClaimsListing()
        rpt.Site = Me.Site
        Return rpt
    End Function
