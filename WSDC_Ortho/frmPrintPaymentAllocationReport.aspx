<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/mstSite.master" CodeBehind="frmPrintPaymentAllocationReport.aspx.vb" Inherits="WSDC_Ortho.frmPrintPaymentAllocationReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeaderContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<form id='frmPrintPaymentAllocationReport' class="form-horizontal" role="form" action="frmPrintPaymentAllocationReport.aspx" runat="server" defaultbutton="btnHidden">
        ...
        <div class="container">
            <h4 style="color: #2d6ca2;" class="col-sm-12"><asp:Label ID="lblTitle" runat="server" Text="Payment Allocation Report"></asp:Label></h4>
            <div class="col-sm-12">
                <div class="form-group">
                    <div class="col-sm-9">
                        <label for="txtFirstName" class="col-xs-3">First Name:
                        ...
                        <label for="txtLastName"  class="col-xs-3">Last Name:
                        ...
                        <label for="dteBeginDate" class="col-sm-4">Begin Date:
                        ...
                        <label for="dteEndDate" class="col-sm-4"> End Date:
                        <span style="padding-left: 0px;">
            ...
            <div class="col-sm-12">
                <span style="padding-left: 0px;">
                    <asp:Button ID="btnPrint" class="btn btn-primary" onFocus="jQuery('.datePicker').datepicker('hide');" runat="server" Text="Print" />
    ...
    <script>
        jQuery(document).ready(function () {
          ...
          .on('changeDate', function (e) {
              ...
              $('#frmPrintPaymentAllocationReport').formValidation('revalidateField', '<%=dteBeginDate.UniqueID%>');
          });
         ...
         $('#dtpEndDate')
          ...
          .on('changeDate', function (e) {
              // Revalidate the date field
              $('#frmPrintPaymentAllocationReport').formValidation('revalidateField', '<%=dteEndDate.UniqueID%>');
        });

        $('#frmPrintPaymentAllocationReport')
           .formValidation({
               framework: 'bootstrap',
               icon: {
