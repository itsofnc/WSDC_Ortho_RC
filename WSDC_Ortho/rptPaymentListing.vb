...
Public Class rptPaymentListing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WSDC_Ortho.rptPaymentListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPaymentListing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPaymentListing = New rptPaymentListing()
        rpt.Site = Me.Site
        Return rpt
    End Function
