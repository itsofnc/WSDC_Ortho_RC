...
Public Class rptPaymentsRecord
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WSDC_Ortho.rptPaymentsRecord.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPaymentsRecord
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPaymentsRecord = New rptPaymentsRecord()
        rpt.Site = Me.Site
        Return rpt
    End Function
